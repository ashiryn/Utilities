...
namespace FluffyVoid.Utilities
{
    ...
    {
        /// <summary>
        ///     Converts the key/value pair into an HTTP query string that can be added to
        ///     an HTTP request
        /// </summary>
        /// <param name="source">
        ///     Reference to the source dictionary convert into a query
        ///     string
        /// </param>
        /// <returns>
        ///     A query string that can be appended to any HTTP request based on the
        ///     key/value pairs
            ...
            this Dictionary<string, string> source)
        {
            ...
            foreach (KeyValuePair<string, string> parameters in source)
            {
                query.Append($"{delimiter}{parameters.Key}={parameters.Value}");
                delimiter = '&';
            }
        ...
        /// <summary>
        ///     Converts a dictionary to a string representation using the passed in string
        ///     formatter
        /// </summary>
        ...
        /// <summary>
        ///     Gets the value associated with the specified key and casts to the desired
        ///     type if able.
        /// </summary>
        /// <param name="source">
        ///     Reference to the source dictionary to get the converted
        ///     value out of
        /// </param>
        /// <param name="key">The key to retrieve a value from</param>
        /// <param name="result">
        ///     The converted result if it was in the dictionary and of
        ///     the type requested
        /// </param>
        ...
        /// <returns>
        ///     True if the key has a value and is of the requested type, otherwise
        ///     false
        /// </returns>
