...
namespace FluffyVoid.Utilities
{
    ...
    public static partial class EnumUtility
    {
        ...
        /// <returns>
        ///     The description string from the attribute if it exists, otherwise the
        ...
        /// <returns>
        ///     The next enum entry in the list, or the 1st entry if incrementing past
        ///     the end
        /// </returns>
            ...
            where T : Enum
        {
            ...
            return entries.Length == entryIndex
                ? entries[0]
                : entries[entryIndex];
        }
        /// <summary>
        ...
        /// <typeparam name="T">The enum type to use</typeparam>
        /// <returns>
        ///     The previous enum entry in the list, or the last entry if decrementing
        ///     past the 1st entry
        /// </returns>
        ...
        /// <summary>
        ///     Converts an enum to a string representation using the passed in string
        ///     formatter
        /// </summary>
        /// <param name="value">The enum to convert</param>
