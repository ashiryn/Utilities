...
namespace FluffyVoid.Utilities
{
    ...
    {
        /// <summary>
        ///     Parses an Enum to find a match by comparing a passed in string to either
        ///     the Description Attribute, or name of each
        ///     Enum entry
        /// </summary>
        /// <param name="description">The description to find</param>
        /// <typeparam name="T">The type of enum to search</typeparam>
        /// <returns>
        ///     The found enum if it has a matching description, or if the name of the
        ///     field matches the description,
        ...
        /// <summary>
        ///     Parses the description attribute from an Enum to allow string formatting of
        ///     an Enum to be separated from coding
        ///     standards
        /// </summary>
        /// <param name="value">The enum to get the description from</param>
        /// <param name="description">
        ///     The found description string if a description attribute was found,
        ///     otherwise the
        ///     Enum.ToString()
        /// </param>
        /// <typeparam name="T">The type of enum to search</typeparam>
        ...
        /// <summary>
        ///     Tries to parse an Enum to find a match by comparing a passed in string to
        ///     either the Description Attribute, or name
        ///     of each Enum entry
        /// </summary>
        /// <param name="description">The description to find</param>
        /// <param name="value">
        ///     The matching enum value if a match was found, otherwise the
        ///     last entry
        /// </param>
        /// <typeparam name="T">The type of enum to search</typeparam>
