...
namespace FluffyVoid.Utilities
{
    ...
    {
        /// <summary>
        ///     Searches the loaded assemblies for classes that have the type of attribute
        ///     assigned to them
        /// </summary>
        /// <param name="inherit">
        ///     Whether the search should include classes that inherit from a class that
        ///     has the attribute
        ///     attached
        /// </param>
        /// <param name="namespaceFilter">
        ///     Optional namespace filter to help narrow down the
        ///     search of attributes
        /// </param>
        /// <typeparam name="TAttributeType">
        ///     The type of attribute to find within the
        ///     loaded assemblies
        /// </typeparam>
        ...
        /// <summary>
        ///     Searches the loaded assemblies for attributes that have been assigned to
        ///     classes
        /// </summary>
        /// <param name="inherit">
        ///     Whether the search should include classes that inherit from a class that
        ...
        ///     Whether to include properties in the table or
        ///     not
        /// </param>
        /// <param name="includeNonPublic">
        ///     Whether to include protected/private fields in
        ///     the table or not
        /// </param>
            ...
            bool    includeNonPublic  = false)
        {
            ...
            foreach (FieldInfo currentField in fields)
            {
                ...
                result.Add(currentField.Name,
                           currentField.GetValue(classObject)!);
            }
        ...
        /// <summary>
        ///     Extension method used to check the type hierarchy for a specific generic
        ///     parent
        /// </summary>
        ...
        /// <returns>
        ///     True if the type is a descendant of the passed in type, or is the
        ///     passed in type, otherwise false
        /// </returns>
        ...
        /// <param name="includeProperties">
        ///     Whether to populate properties as well as
        ///     fields
        /// </param>
        /// <param name="includeNonPublic">
        ///     Whether to populate protected/private fields as
        ///     well
        /// </param>
        ...
        public static bool TryGetType(string           typeName,
                                      out    Type?     result,
        ...
        public static bool TryGetTypeFromName(string    typeName,
                                              out Type? result,
                                              string?   namespaceFilter = null)
        {
            foreach (Type currentType in from assembly in AppDomain
                                             .CurrentDomain
                                             .GetAssemblies()
