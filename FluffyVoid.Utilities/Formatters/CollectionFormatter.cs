...
{
    /// <summary>
    ///     String formatter designed to iterate over a collection and format each item
    ///     using a targeted string formatter for the items
    /// </summary>
        ...
        where TCollection : IEnumerable<TType>
    {
        ...
        ///     The type of string formatter to use for each item in
        ///     the collection
        /// </param>
