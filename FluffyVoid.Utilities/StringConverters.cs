namespace FluffyVoid.Utilities
{
    public static partial class StringUtility
    {
        ...
        /// <returns>
        ///     An array of bytes if the conversion was successful, otherwise
        ///     default(byte[])
        /// </returns>
        ...
        /// <param name="value">The string to convert</param>
        /// <returns>
        ///     An array of chars if the conversion was successful, otherwise
        ///     default(char[])
        /// </returns>
        ...
        /// <param name="value">The string to convert</param>
        /// <returns>
        ///     An array of SBytes if the conversion was successful, otherwise
        ///     default(sbyte[])
        /// </returns>
