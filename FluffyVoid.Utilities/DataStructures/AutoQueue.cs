...
{
    /// <summary>
    ///     Custom queue that can process IQueueable objects automatically with dynamic
    ///     queue times for each item in the queue
    /// </summary>
        ...
        where T : IQueueable
    {
        ...
        /// <summary>
        ///     Processes the next item in the queue, skipping any current wait time in
        ///     effect
        /// </summary>
        ...
        /// <summary>
        ///     Updates the currently active queue time to dispatch items at variable
        ///     intervals
        /// </summary>
