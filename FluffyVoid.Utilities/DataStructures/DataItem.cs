...
{
    /// <summary>
    ///     Wrapper for an object that allows for notifications when the value has been
    ///     changed
    /// </summary>
    ...
    public class DataItem<TType> : IDataItem
    {
        ...
        /// <summary>
        ///     String formatter that allows for an optional way to format the value in a
        ///     readable way
        /// </summary>
        ...
        /// <summary>
        ///     ToString override that attempts to use an assigned string formatter if it
        ///     can, otherwise it will ToString the
