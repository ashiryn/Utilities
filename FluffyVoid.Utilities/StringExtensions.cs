...
namespace FluffyVoid.Utilities
{
    ...
    public static partial class StringUtility
    {
        ...
        {
            return char.TryParse(value, out char result)
                ? result
                : '\0';
        }
        /// <summary>
        ...
        /// <summary>
        ///     Replaces any invalid file name characters with the '-' character to ensure
        ///     safe file paths
        /// </summary>
        ...
        {
            return ushort.TryParse(value, out ushort result)
                ? result
                : (ushort)0;
        }
        /// <summary>
        ...
        ///     The maximum number of characters allowed before
